...
export default function CreateChatbotModal({ isOpen, onClose, onSubmit }: CreateChatbotModalProps) {
  ...
  const validate = () => {
    ...
    if (formData.systemPrompt && formData.systemPrompt.length > 1000) {
      newErrors.systemPrompt = 'System prompt must be less than 1000 characters';
    }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className={`input resize-none ${errors.systemPrompt ? 'border-red-500' : ''}`}
